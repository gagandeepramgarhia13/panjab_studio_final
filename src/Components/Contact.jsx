...
//             <div className="space-y-2 sm:space-y-3 text-gray-200 text-xs sm:text-sm md:text-base">
//               <a href="https://maps.app.goo.gl/QzHDSRLRRfAcJePT6" target="_blank" className="text-white  hover:text-yellow-400 transition"><span>📍 Smethwick Birmingham, B66 3BL</span></a><br />
//               <a href="tel:+447873600056" className="text-white  hover:text-yellow-400 transition"><span>📞 +447873600056</span></a><br />
//               <a href="mailto:info@panjabstudios.com" className="text-white  hover:text-yellow-400 transition"><span>📧 info@panjabstudios.com</span></a>
//             </div>
...
//             bg-black/40 rounded-lg sm:rounded-xl 
//             flex items-center justify-center text-gray-400 text-xs sm:text-sm md:text-base">
//             <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2429.1889965693445!2d-1.9667324000000002!3d52.493818350000005!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4870bd68291de107%3A0xe945dddbb525b332!2sPiddock%20Rd%2C%20Smethwick%20B66%203BL%2C%20UK!5e0!3m2!1sen!2sin!4v1782286335625!5m2!1sen!2sin" width="100%" height="100%" className="rounded-xl"></iframe>
//           </div>
...
export default function Contact() {
  ...
  // Find each social link from data.js by matching the icon name
  const instagram = followLinks.find((l) => l.icon.includes("instagram"));
  const tiktok = followLinks.find((l) => l.icon.includes("tiktok"));
  const youtube = followLinks.find((l) => l.icon.includes("youtube"));
  const whatsappNumber = "+447873600056"; // 🔁 same number used in your phone link above

  const socialButtons = [
    { name: "Instagram", url: instagram?.url },
    { name: "TikTok", url: tiktok?.url },
    { name: "WhatsApp", url: `https://wa.me/${whatsappNumber.replace(/[^\d]/g, "")}` },
