...
//       {/* Mobile Menu */}
//       {isOpen && (
//         <div className="mx-6 mt-2 bg-white/90 backdrop-blur-md rounded-xl p-4 shadow-lg md:hidden">
//           <ul className="flex flex-col gap-4 text-[#d4af37] font-medium">
//             {menuItems.map((item, index) => (
//               <li
//                 key={index}
//                 onClick={() => {
...
//                   setIsOpen(false);
//                 }}
//                 className="cursor-pointer transition hover:text-black [text-shadow:1px_1px_3px_rgba(0,0,0,0.6)]"
//               >
//                 {item}
//               </li>
//             ))}
